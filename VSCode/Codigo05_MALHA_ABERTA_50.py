...
try:
    ...
    plt.savefig('Grafico_TCLab_Modelo_Malha_Aberta_50.png', dpi=300, bbox_inches='tight')

    # Salvar dados em .txt
    np.savetxt('Dados_simulacao_Malha_Aberta_50.txt', np.column_stack((tm, T1, Q1)),
               header='Tempo (s)\tTemperatura Real (°C)\tPotência (%)', fmt='%.2f', delimiter='\t')
