...
try:
    ...
    plt.savefig('Grafico_TCLab_Todos_Modelos_Comparados_Malha_Fechada.png', dpi=300, bbox_inches='tight')

    # Salvar dados em .txt
    np.savetxt('Dados_simulacao_11_Modelos_Comparados_Malha_Fechada.txt', np.column_stack((tm, T1, T1_ModeloNL, T1_ModeloL, T1_ModeloHAG, T1_ModeloSmith, T1_ModeloSundaresan, T1_ModeloZN, Q1)),
