...
try:
    ...
    plt.savefig('Grafico_TCLab_Todos_Modelos_Comparados_Malha_Fechada_KP5.png', dpi=300, bbox_inches='tight')

    # Salvar dados em .txt
    np.savetxt('Dados_simulacao_12_Modelos_Comparados_Malha_Fechada_KP5.txt', np.column_stack((tm, T1, T1_ModeloNL, T1_ModeloL, T1_ModeloHAG, T1_ModeloSmith, T1_ModeloSundaresan, T1_ModeloZN, Q1)),
