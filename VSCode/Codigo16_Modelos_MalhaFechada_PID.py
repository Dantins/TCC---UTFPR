...
try:
    for i in range(loops):
        ...
        leg1 = ax1.legend(loc='best', fontsize=10, ncol=1)
        ...
        leg2 = ax2.legend(loc='best', fontsize=10, ncol=1)
    ...
    plt.savefig('Grafico_TCLab_Todos_Modelos_Comparados_Malha_Fechada_PID.png', dpi=300, bbox_inches='tight')
    np.savetxt('Dados_simulacao_PID.txt',
